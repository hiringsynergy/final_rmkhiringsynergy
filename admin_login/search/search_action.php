...
if(isset($_POST['send_mail']) && isset($_POST['filter']) && isset($_SESSION['user_role'])=='admin'  ){
    ...
    $query_mail = "select * from students_".$get_year." where st_ugspecialization in ('$temp_branch') and st_cgpa>='$get_cgpa' and st_12thpercentage>='$get_12thpercentage' and st_10thpercentage>='$get_10thpercentage' and st_historyofarrears<='$get_historyofarrears' and st_standingarrears<='$get_standingarrears' and st_gapinstudies <= '$get_gapinstudy'";
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                                    ...
                                    <div>
                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                            ...
                                            if(isset($_GET['search']) && isset($_SESSION['user_role'])=='admin' ){
                                                ...
                                                //st_ugyearofpassing='$get_year' and ...   and st_gapinstudies <= '$get_gapinstudy'
                            ...
                            $query = "select * from students_".$get_year." where st_ugspecialization in ('$temp_branch') and st_cgpa>='$get_cgpa' and st_12thpercentage>='$get_12thpercentage' and st_10thpercentage>='$get_10thpercentage' and st_historyofarrears<='$get_historyofarrears'  and st_gender in ('$get_gender') and st_standingarrears<='$get_standingarrears' and st_currentlypursuing='UG' and $dorh='h'   UNION SELECT * FROM students_".$get_year." where st_pgspecialization in ('$temp_pgbranch')  and st_pgcgpa>='$get_pgcgpa' UNION select * from students_".$get_year." where st_ugspecialization in ('$temp_branch') and st_cgpa>='$get_cgpa' and st_dippercentage>='$get_dippercentage' and st_10thpercentage>='$get_10thpercentage' and st_historyofarrears<='$get_historyofarrears'  and st_gender in ('$get_gender') and st_standingarrears<='$get_standingarrears' and st_currentlypursuing='UG' and $dorh='d' UNION select * from students_".$get_year." where st_ugspecialization in ('$temp_branch') and st_cgpa>='$get_cgpa' and st_dippercentage>='$get_dippercentage' and st_12thpercentage>='$get_12thpercentage'  and st_10thpercentage>='$get_10thpercentage' and st_historyofarrears<='$get_historyofarrears'  and st_gender in ('$get_gender') and st_standingarrears<='$get_standingarrears' and st_currentlypursuing='UG' and $dorh='dh'";
