                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            $query = "select * from students_".$get_year." where st_ugspecialization in ('$temp_branch') and st_cgpa>='$get_cgpa' and st_12thpercentage>='$get_12thpercentage' and st_10thpercentage>='$get_10thpercentage' and st_historyofarrears<='$get_historyofarrears'  and st_gender in ('$get_gender') and st_standingarrears<='$get_standingarrears' and st_currentlypursuing='UG' WHERE $dorh='h'   UNION SELECT * FROM students_".$get_year." where st_pgspecialization in ('$temp_pgbranch')  and st_pgcgpa>='$get_pgcgpa' UNION select * from students_".$get_year." where st_ugspecialization in ('$temp_branch') and st_cgpa>='$get_cgpa' and st_dippercentage>='$get_dippercentage' and st_10thpercentage>='$get_10thpercentage' and st_historyofarrears<='$get_historyofarrears'  and st_gender in ('$get_gender') and st_standingarrears<='$get_standingarrears' and st_currentlypursuing='UG' WHERE $dorh='d' UNION select * from students_".$get_year." where st_ugspecialization in ('$temp_branch') and st_cgpa>='$get_cgpa' and st_dippercentage>='$get_dippercentage' and st_12thpercentage>='$get_12thpercentage'  and st_10thpercentage>='$get_10thpercentage' and st_historyofarrears<='$get_historyofarrears'  and st_gender in ('$get_gender') and st_standingarrears<='$get_standingarrears' and st_currentlypursuing='UG' WHERE $dorh='dh'";
