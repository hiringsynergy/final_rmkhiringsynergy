                        ...
                        if(isset($_FILES['file'])){
                            ...
                            foreach ($objPHPExcel->getWorksheetIterator() as $worksheet)
                            {
                                ...
                                while ($serial!=NULL)
                                {
                                    ...
                                    $_12percentage=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(26, $row)->getValue()),2),2);
                                    ...
                                    $dippercentage=round( convert( mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(31, $row)->getValue()),2),2);
                                    ...
                                    $ug1sem=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(38, $row)->getValue()),2),2);
                                    $ug2sem= round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(39, $row)->getValue()),2),2);
                                    $ug3sem=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(40, $row)->getValue()),2),2);
                                    $ug4sem=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(41, $row)->getValue()),2),2);
                                    $ug5sem=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(42, $row)->getValue()),2),2);
                                    $ug6sem=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(43, $row)->getValue()),2),2);
                                    $ug7sem=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(44, $row)->getValue()),2),2);
                                    $ug8sem=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(45, $row)->getValue()),2),2);
                                    $cgpa= round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(46, $row)->getValue()),2),2);
                                    ...
                                    $pg1sem=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(50, $row)->getValue()),2),2);
                                    $pg2sem=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(51, $row)->getValue()),2),2);
                                    $pg3sem=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(52, $row)->getValue()),2),2);
                                    $pg4sem=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(53, $row)->getValue()),2),2);
                                    $pgcgpa=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(54, $row)->getValue()),2),2);
                                    ...
                                    $english=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(74, $row)->getValue()),2),2);
                                    $quantitative=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(75, $row)->getValue()),2),2);
                                    $logical= round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(76, $row)->getValue()),2),2);
                                    $overall= round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(77, $row)->getValue()),2),2);
                                    $percentage=round(convert(mysqli_real_escape_string($connect, $worksheet->getCellByColumnAndRow(78, $row)->getValue()),2),2);
                                    ...
                                    if(preg_match('/rmd/', $database_name)){
                                        ...
                                        $sql = "INSERT INTO students_$year VALUES ('$roll','$first_name','$middle_name','$last_name','$name','$gender','$father_name','$father_occupation','$father_mobile',  '$mother_name','$mother_occupation','$mother_mobile','$college_email','$email','$phone','$dob','$nationality','$caste','$college_name','$university','$_10percentage','$_10institution','$_10boardofstudy','$_10medium','$_10yearofpassing','$_12percentage','$_12institution','$_12boardofstudy','$_12medium','$_12yearofpassing','$dippercentage','$dipspecialization','$dipinstitution','$dipyearofpassing','$current','$ugdeg','$ugspecial','$ug1sem','$ug2sem','$ug3sem','$ug4sem','$ug5sem','$ug6sem','$ug7sem','$ug8sem','$cgpa','$ugyearofpassing','$pgdeg','$pgspecial','$pg1sem','$pg2sem','$pg3sem','$pg4sem','$pgcgpa','$pgyearofpassing','$ugcollegename','$ughistoryofarrears','$dayhostel','$historyofarrears','$standingarrears','$hometown','$address1','$address2','$city','$state','$postal_code','$landline','$skill','$duration','$vendor','$coecertification','$gap','$reason','$english','$quantitative','$logical','$overall','$percentage','$candidate','$signature','$placement_status','$aadhar','$passport','$pan','$pass_secured','rmk.jpg','','$dorh','','','')";
                                    }
