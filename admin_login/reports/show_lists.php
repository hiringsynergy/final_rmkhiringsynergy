                                        ...
                                        <div class="tabbable">
                                            ...
                                            if($_GET['flag']==0) {
                                                ...
                                                Eligible
                                                    ...
                                                    $query_count = " SELECT * FROM students_".$year_of_gradudation." WHERE _" .$jid. "='appliable' OR  _" .$jid. "='accepted' OR _" .$jid. "='placed' OR _" .$jid. "='unplaced'";
                                                ...
                                                <span class="badge badge-danger">
                                                    ...
                                                    $query_count = " SELECT * FROM students_".$year_of_gradudation." WHERE _" .$jid. "='appliable'";
                                                    $result_count = mysqli_query($connect, $query_count);
                                                    $eligible = mysqli_num_rows($result_count);
                                            ...
                                            <?php
                                                ...
                                                <ul class="nav nav-tabs" id="myTab">
                                                    ...
                                                    $query_count = " SELECT * FROM students_".$year_of_gradudation." WHERE _" .$jid. "='appliable' OR  _" .$jid. "='accepted' OR _" .$jid. "='placed'";
                                                    $result_count = mysqli_query($connect, $query_count);
                                                    $eligible = mysqli_num_rows($result_count);
                                                    ...
                                                    <div>
                                                        <table id="dynamic-table"
                                                            ...
                                                            if (isset($_GET['jid']) && $_GET['flag']==0 && isset($_SESSION['user_role'])=='admin' ) {
                                                                ...
                                                                $query_job = " SELECT * FROM students_".$year_of_gradudation." WHERE _" .$jid. "='appliable' OR  _" .$jid. "='accepted' OR _" .$jid. "='placed'";
